...
#define __CONFIG_H
  ...
  #define LED1_CLOCK		(RCC->APB2ENR |= RCC_APB2ENR_IOPAEN)
	...
	#define LED1_CLOCK		RCC_APB2ENR_IOPAEN | RCC_APB2ENR_AFIOEN
	#define LED1_BIT_0		SET_BIT(GPIOA->CRH, GPIO_CRH_CNF15_0 | GPIO_CRH_MODE15)
	#define LED1_BIT_1		WRITE_REG(AFIO->MAPR, AFIO_MAPR_SWJ_CFG_JTAGDISABLE); CLEAR_BIT(GPIOA->CRH, GPIO_CRH_CNF15_1)
	#define LED1_MODE
	#define LED1_OFF		WRITE_REG(GPIOA->BSRR, GPIO_BSRR_BS15)
	#define LED1_ON			WRITE_REG(GPIOA->BRR, GPIO_BRR_BR15)

	#define BOOT_PIN_CLOCK  RCC_APB2ENR_IOPBEN
	#define READ_BOOT_PIN   (!READ_BIT(GPIOB->IDR, GPIO_IDR_IDR0))
	#define CONFIG_BOOT_PIN CLEAR_BIT(GPIOB->CRL, GPIO_CRL_CNF0_0); SET_BIT(GPIOB->CRL, GPIO_CRL_CNF0_1); WRITE_REG(GPIOB->BSRR, GPIO_BSRR_BS0);//enable pullup
...
#define CONFIG_BOOT_PIN CLEAR_BIT(GPIOB->CRL, GPIO_CRL_CNF2_0); SET_BIT(GPIOB->CRL, GPIO_CRL_CNF2_1); CLEAR_BIT(GPIOB->ODR, GPIO_ODR_ODR2);

#else
	/* PB2 is already in FLOATING mode by default. */
#ifndef CONFIG_BOOT_PIN
#define CONFIG_BOOT_PIN
#endif

#endif

#ifndef BOOT_PIN_CLOCK
#define BOOT_PIN_CLOCK 0
#endif
#ifndef READ_BOOT_PIN
#define READ_BOOT_PIN   READ_BIT(GPIOB->IDR, GPIO_IDR_IDR2)
#endif
